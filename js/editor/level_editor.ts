...
export const PALETTE: PaletteItem[] = [
    ...
    { type: TILES.WEAPON_SPREAD, name: 'Spread Cannon', icon: '🔱', color: '#ff00dd' },
    { type: TILES.WEAPON_GRENADE, name: 'Plasma Grenade', icon: '💣', color: '#00ff66' },
    { type: TILES.WEAPON_MISSILE, name: 'Seeker Missile', icon: '🎯', color: '#ff6600' },
